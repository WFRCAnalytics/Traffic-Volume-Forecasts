...
require([
  ...
  function matchModelAADT() {
    ...
    function calculateValue(idPrefix) {
      ...
      var mfValue = document.getElementById(
        "mf" + idPrefix + "Value"
      ).innerHTML;
  ...
  function updateMap() {
    ...
    if (
      document.getElementById("selectForecastArea").value !== "Entire State"
    ) {
      ...
      if (document.getElementById("selectCoName").value !== "All Counties") {
        layerSegments.definitionExpression =
          "CO_NAME = '" +
          document.getElementById("selectCoName").value +
          "' AND F_AREA = '" +
          document.getElementById("selectForecastArea").value +
          "'";
      }
      ...
      if (document.getElementById("selectCoName").value !== "All Counties") {
        layerSegments.definitionExpression =
          "CO_NAME = '" + document.getElementById("selectCoName").value + "'";
      }
    ...
    layerSegments.definitionExpression = buildDefinitionExpression(
      layerSegments.definitionExpression,
      _flagsSegListExpression
    );
    layerFlags.definitionExpression = buildDefinitionExpression(
      layerSegments.definitionExpression,
      _flagsMapExpression
    );
    ...
    switch (curDisplayForecast) {
      case "final-forecast":
        ...
        rendererSegmentsVolume.valueExpressionTitle =
          /*selectYear.value + ' */ "Final Forecast";
        ...
        layerSeTypemp.renderer.valueExpression =
          "$feature.N_" + selectYear.value;
        labelClassSe.labelExpressionInfo.expression =
          "Text($feature.N_" + selectYear.value + ", '#,###')";
      ...
      case "final-forecast-change-2019":
        ...
        layerSeHh.renderer.valueExpression =
          "$feature.N_" + selectYear.value + " - $feature.N_2019";
      ...
      case "manual-adjustments":
        ...
        rendererSegmentsVolumeAdjust.valueExpressionTitle =
          /*selectYear.value + ' */ "Manual Adjustments";
      ...
      case "historic-adjustments":
        ...
        rendererSegmentsVolumeAdjust.valueExpression = _expression;
        rendererSegmentsVolumeAdjust.valueExpressionTitle =
          /*selectYear.value + ' */ "Historic Adjustments";
        layerSegments.renderer = rendererSegmentsVolumeAdjust;
        labelClass.labelExpressionInfo.expression =
          "IIF(" +
          _expression +
      ...
      case "model-forecast":
        ...
        layerSeTypemp.renderer.valueExpression =
          "$feature.N_" + selectYear.value;
        labelClassSe.labelExpressionInfo.expression =
          "IIF($feature.N_" + selectYear.value + ", '#,###'))";
        layerSeHh.renderer = rendererSeHh;
        layerSePop.renderer = rendererSePop;
        layerSeTypemp.renderer = rendererSeTypemp;
        break;
    ...
    if (_phase != "") {
      layerRoadwayProjectsLines.definitionExpression =
        filterRoadwayProjectsLinesFilter + " AND Phase = '" + _phase + "'";
      layerRoadwayProjectsPoints.definitionExpression =
        filterRoadwayProjectsPointsFilter + " AND Phase = '" + _phase + "'";
      layerTransitProjectsLines.definitionExpression =
        filterTransitProjectsLinesFilter + " AND Phase = '" + _phase + "'";
      layerTransitProjectsPoints.definitionExpression =
        filterTransitProjectsPointsFilter + " AND Phase = '" + _phase + "'";
    } else {
      layerRoadwayProjectsLines.visible = false;
      layerRoadwayProjectsPoints.visible = false;
      layerTransitProjectsLines.visible = false;
    ...
    layerSegments.load().then(function () {
      ...
      function addUpdateListener(elementId) {
        document
          ...
          .addEventListener("calciteCheckboxChange", updateMap);
      }
  ...
  function createMapView() {
    ...
    const polylineRenderer = new UniqueValueRenderer({
      ...
      uniqueValueInfos: [
        {
          value: "1",
          symbol: { type: "simple-line", color: "#d73027", width: "3px" },
        },
        {
          value: "2",
          symbol: { type: "simple-line", color: "#0093bf", width: "3px" },
        },
        {
          value: "3",
          symbol: { type: "simple-line", color: "#4d33a7", width: "3px" },
        },
        {
          value: "Unfunded",
          symbol: { type: "simple-line", color: "#ffa484", width: "3px" },
        },
      ],
    });
    ...
    rendererSeHh = new ClassBreaksRenderer({
      ...
      classBreakInfos: [
        ...
        },
        {
          ...
          symbol: {
            type: "simple-fill",
            color: [191, 191, 226, 0.5],
            outline: { color: [255, 255, 255], width: 1.1 },
          },
          label: "50 to 499 households",
        },
        {
          minValue: 500,
          maxValue: 1000,
          symbol: {
            type: "simple-fill",
            color: [127, 127, 197, 0.5],
            outline: { color: [255, 255, 255], width: 1.7 },
          },
          label: "500 to 999 households",
        },
        {
          minValue: 1000,
          maxValue: 2000,
          symbol: {
            type: "simple-fill",
            color: [63, 63, 168, 0.5],
            outline: { color: [255, 255, 255], width: 2.3 },
          },
          label: "1,000 to 1,999 households",
        },
        {
          minValue: 2000,
          maxValue: Infinity,
          symbol: {
            type: "simple-fill",
            color: [0, 0, 139, 0.5],
            outline: { color: [255, 255, 255], width: 3.9 },
          },
          label: "More than 2,000 households",
        },
      ],
    });
    ...
    rendererSePop = new ClassBreaksRenderer({
      ...
      classBreakInfos: [
        ...
        },
        {
          ...
          symbol: {
            type: "simple-fill",
            color: [223, 191, 223, 0.5],
            outline: { color: [255, 255, 255], width: 1.1 },
          },
          label: "100 to 999 people",
        },
        {
          minValue: 1000,
          maxValue: 2000,
          symbol: {
            type: "simple-fill",
            color: [191, 127, 191, 0.5],
            outline: { color: [255, 255, 255], width: 1.7 },
          },
          label: "1,000 to 1,999 people",
        },
        {
          minValue: 2000,
          maxValue: 4000,
          symbol: {
            type: "simple-fill",
            color: [159, 63, 159, 0.5],
            outline: { color: [255, 255, 255], width: 2.3 },
          },
          label: "2,000 to 3,999 people",
        },
        {
          minValue: 4000,
          maxValue: Infinity,
          ...
          label: "More than 4,000 households",
        },
      ],
    });
    ...
    rendererSeTypemp = new ClassBreaksRenderer({
      ...
      classBreakInfos: [
        ...
        },
        {
          ...
          symbol: {
            type: "simple-fill",
            color: [242, 212, 191, 0.5],
            outline: { color: [255, 255, 255], width: 1.1 },
          },
          label: "100 to 999 jobs",
        },
        {
          minValue: 1000,
          maxValue: 3000,
          symbol: {
            type: "simple-fill",
            color: [229, 170, 127, 0.5],
            outline: { color: [255, 255, 255], width: 1.7 },
          },
          label: "1,000 to 2,999 jobs",
        },
        {
          minValue: 3000,
          maxValue: 6000,
          symbol: {
            type: "simple-fill",
            color: [216, 127, 63, 0.5],
            outline: { color: [255, 255, 255], width: 2.3 },
          },
          label: "2,000 to 5,999 jobs",
        },
        {
          minValue: 6000,
          maxValue: Infinity,
  ...
  fetch("config.json")
    ...
    .then((config) => {
      ...
      filterRoadwayProjectsLinesFilter =
        config["filterRoadwayProjectsLinesFilter"];
      filterTransitProjectsLinesFilter =
        config["filterTransitProjectsLinesFilter"];
      filterRoadwayProjectsPointsFilter =
        config["filterRoadwayProjectsPointsFilter"];
      filterTransitProjectsPointsFilter =
        config["filterTransitProjectsPointsFilter"];
      filterRoadwayProjectsLinesFilterPrevPhase =
        config["filterRoadwayProjectsLinesFilterPrevPhase"];
      filterTransitProjectsLinesFilterPrevPhase =
        config["filterTransitProjectsLinesFilterPrevPhase"];
      filterRoadwayProjectsPointsFilterPrevPhase =
        config["filterRoadwayProjectsPointsFilterPrevPhase"];
      filterTransitProjectsPointsFilterPrevPhase =
        config["filterTransitProjectsPointsFilterPrevPhase"];
      ...
      rendererSegmentsVolume = new ClassBreaksRenderer(
        config["rendererSegmentsVolume"]
      );
      rendererSegmentsVolumeCompare = new ClassBreaksRenderer(
        config["rendererSegmentsVolumeCompare"]
      );
      rendererSegmentsVolumeAdjust = new ClassBreaksRenderer(
        config["rendererSegmentsVolumeAdjust"]
      );
      rendererRoadwayPoints = new SimpleRenderer(
        config["rendererRoadwayPoints"]
      );
      rendererRoadwayLines = new SimpleRenderer(config["rendererRoadwayLines"]);
      rendererTransitPoints = new SimpleRenderer(
        config["rendererTransitPoints"]
      );
      rendererTransitLines = new SimpleRenderer(config["rendererTransitLines"]);
      rendererRoadwayPointsPrevPhase = new SimpleRenderer(
        config["rendererRoadwayPointsPrevPhase"]
      );
      rendererRoadwayLinesPrevPhase = new SimpleRenderer(
        config["rendererRoadwayLinesPrevPhase"]
      );
      rendererTransitPointsPrevPhase = new SimpleRenderer(
        config["rendererTransitPointsPrevPhase"]
      );
      rendererTransitLinesPrevPhase = new SimpleRenderer(
        config["rendererTransitLinesPrevPhase"]
      );
      rendererSegmentsFlags = new SimpleRenderer(
        config["rendererSegmentsFlags"]
      );
  ...
  async function loadAppData() {
    ...
    const uniqueForecastAreas = [
      ...new Set(dataSegments.map((item) => item.F_AREA)),
    ].sort();
    ...
    const _prevSelectedForecastArea = retrieveStringFromLocalStorage(
      "selectedForecastArea"
    );
    ...
    function updateCoNames() {
      ...
      storeStringInLocalStorage(
        "selectedForecastArea",
        selectForecastArea.value
      );
      ...
      if (
        ...
        coNames = dataSegments
          .filter(
            (item) =>
              item.F_AREA ===
              document.getElementById("selectForecastArea").value
          )
          .map((item) => item.CO_NAME);
      }
    ...
    function populateComboboxFlags() {
      ...
      dataFlags.forEach((flag) => {
        ...
        const checkboxLabel = createCalciteCheckboxWithLabel(
          flag.flagName,
    ...
    function updateSegments() {
      ...
      if (
        ...
        whereCondition.push(
          `F_AREA = '${document.getElementById("selectForecastArea").value}'`
        );
        ...
        document.getElementById("selectCoName").value !== "All Counties"
      ) {
        whereCondition.push(
          `CO_NAME = '${document.getElementById("selectCoName").value}'`
        );
    ...
    button.addEventListener("click", function () {
      ...
      if (
        select &&
        select.children &&
        select.selectedOption.nextElementSibling
      ) {
    ...
    buttonPrev.addEventListener("click", function () {
      ...
      if (
        select &&
        select.children &&
        select.selectedOption.previousElementSibling
      ) {
        // Increment the selectedIndex to select the next option
        selectSegId.selectedOption =
          select.selectedOption.previousElementSibling;
        updatePanelInfo();
      } else {
        //alert('No more items to select.'); // Alert if there's no next option or if select is not found
    ...
    function applyEdits() {
        ...
        .then(function (results) {
          ...
          if (results.features.length > 0) {
            ...
            function getRoundedAdjustment(year) {
              const adjValueElement = document.getElementById(
                "adj" + year + "Value"
              );
              const adjHistValue = parseInt(
                document.getElementById("adjHistValue").value || 0
              );
              const currentValue = featureToUpdate.attributes["MF" + year];
              const adjustmentValue = parseInt(adjValueElement.value);
              const roundedValue = customRounding(
                currentValue + adjustmentValue + adjHistValue
              );
            ...
            featureToUpdate.attributes.ADJ2023 =
              getRoundedAdjustment("2023") || 0;
            featureToUpdate.attributes.ADJ2028 =
              getRoundedAdjustment("2028") || 0;
            featureToUpdate.attributes.ADJ2032 =
              getRoundedAdjustment("2032") || 0;
            featureToUpdate.attributes.ADJ2042 =
              getRoundedAdjustment("2042") || 0;
            featureToUpdate.attributes.ADJ2050 =
              getRoundedAdjustment("2050") || 0;
            featureToUpdate.attributes.ADJHIST = parseInt(
              document.getElementById("adjHistValue").value
            );
            featureToUpdate.attributes.NOTES = document
              .getElementById("notes")
              .value.trim();
            featureToUpdate.attributes.NOTES_FURR = document
              .getElementById("notes_furr")
              .value.trim();
            featureToUpdate.attributes.NOTES_SEG = document
              .getElementById("notes_seg")
              .value.trim();
            ...
            dataFlags.forEach((flag) => {
              ...
              if (_prvValue === 1 && _newValue === 0) {
                featureToUpdate.attributes[
                  flag.flagName.replace("FL_", "OV_")
                ] = 0;
              }
      ...
      newFeature.attributes.ADJ2023 =
        document.getElementById("adj2023Value").value || 0;
      newFeature.attributes.ADJ2028 =
        document.getElementById("adj2028Value").value || 0;
      newFeature.attributes.ADJ2032 =
        document.getElementById("adj2032Value").value || 0;
      newFeature.attributes.ADJ2042 =
        document.getElementById("adj2042Value").value || 0;
      newFeature.attributes.ADJ2050 =
        document.getElementById("adj2050Value").value || 0;
      newFeature.attributes.ADJHIST =
        document.getElementById("adjHistValue").value || 0;
      newFeature.attributes.NOTES = document
        .getElementById("notes")
        .value.trim();
      newFeature.attributes.NOTES_FURR = document
        .getElementById("notes_furr")
        .value.trim();
      newFeature.attributes.NOTES_SEG = document
        .getElementById("notes_seg")
        .value.trim();
    ...
    async function updatePanelInfo() {
      ...
      const filteredModForecasts = dataModVolAdj.filter(
        (item) => item.SEGID === _curSegId
      );
      const filteredLinForecasts = dataLinForecasts.filter(
        (item) => item.SEGID === _curSegId
      );

      const responseProjectionGroups = await fetch(
        "data/projection-groups.json"
      );
      ...
      borderDash = dataProjectionGroups.map((item) =>
        JSON.parse(item.pgBorderDash)
      );
      ...
      if (result.features.length > 0) {
        ...
        const chartDataAadt = filteredAadt
          .map((item) => ({ x: item.YEAR, y: item.AADT }))
          .sort((a, b) => a.x - b.x);
        const chartDataAadtAdj = filteredAadt
          .map((item) => ({
            x: item.YEAR,
            y: item.AADT + adjustments_historic,
          }))
          .sort((a, b) => a.x - b.x);
        const chartDataModForecasts = filteredModForecasts
          .map((item) => ({
            x: item.YEAR,
            y: item.modForecast + adjustments_historic,
          }))
          .sort((a, b) => a.x - b.x);
        ...
        const chartDataModDyvol = filteredModForecasts
          .map((item) => ({ x: item.YEAR, y: item.DY_VOL }))
          .sort((a, b) => a.x - b.x);
        const chartDataModLanes = filteredModForecasts
          .map((item) => ({ x: item.YEAR, y: item.LANES }))
          .sort((a, b) => a.x - b.x);
        const chartDataModFt = filteredModForecasts
          .map((item) => ({ x: item.YEAR, y: item.FT }))
          .sort((a, b) => a.x - b.x);
        const chartDataModAt = filteredModForecasts
          .map((item) => ({ x: item.YEAR, y: item.ATYPENAME }))
          .sort((a, b) => a.x - b.x);

        // Create a map of adjustments for faster lookup
        const adjustmentMap = new Map(
          adjustments.map((adj) => [adj.year, adj.adj])
        );

        // Your existing code
        const chartDataForecasts = chartDataModForecasts.map((dataPoint) => ({
          ...dataPoint,
        }));
        ...
        yearsToAdd.forEach((yearToAdd) => {
          if (
            !chartDataForecasts.some((dataPoint) => dataPoint.x === yearToAdd)
          ) {
        ...
        chartDataForecasts.forEach((dataPoint) => {
          ...
          const foundAdjustment = adjustments.find(
            (adjustment) => adjustment.year === year
          );
        ...
        const groupedLinForecasts = filteredLinForecasts.reduce(
          (groups, item) => {
        ...
        const linForecastDatasets = Object.entries(groupedLinForecasts).map(
          ([key, group], index) => ({
            label: key, //'Linear Forecasts - ' + key,
            data: group.map((item) => ({
              x: item.YEAR,
              y: item.linForecast + adjustments_historic,
            })),
        ...
        document.getElementById("adj2023Value").value =
          feature.attributes.ADJ2023 || 0;
        document.getElementById("adj2028Value").value =
          feature.attributes.ADJ2028 || 0;
        document.getElementById("adj2032Value").value =
          feature.attributes.ADJ2032 || 0;
        document.getElementById("adj2042Value").value =
          feature.attributes.ADJ2042 || 0;
        document.getElementById("adj2050Value").value =
          feature.attributes.ADJ2050 || 0;
        document.getElementById("adjHistValue").value =
          feature.attributes.ADJHIST || 0;
        document.getElementById("notes").value =
          feature.attributes.NOTES.trim();
        document.getElementById("notes_furr").value =
          feature.attributes.NOTES_FURR.trim();
        document.getElementById("notes_seg").value =
          feature.attributes.NOTES_SEG.trim();
          ...
          if (element) {
            if (index === 0) {
              ...
              if (chartDataForecasts[index] && chartDataForecasts[index - 1]) {
                const difference =
                  chartDataForecasts[index].y - chartDataForecasts[index - 1].y;
        ...
        function generateTable() {
          ...
          if (renderedFlags.length) {
            tableHtml =
              '<table border="0" width="300px"><thead><tr><th colspan="2" align="left">Flag Overrides</th></tr></thead><tbody>' +
              tableHtml +
              "</tbody></table>";
          }
    ...
    selectForecastArea.addEventListener(
    ...
    document
      .getElementById("matchModelButton")
      .addEventListener("click", matchModelAADT);
        ...
        if (result) {
          ...
          querySEGIDByOBJECTID(featureOBJECTID).then(function (SEGID) {
            if (isValueInCalciteSelect(SEGID, selectSegId)) {
              ...
              alert(
                `${SEGID} not found in the dropdown. There are too many segments to display all in dropdown. Please filter segments further.`
              );
            }
          });
          ...
          function isValueInCalciteSelect(value, calciteSelectElement) {
            const options =
              calciteSelectElement.querySelectorAll("calcite-option");
